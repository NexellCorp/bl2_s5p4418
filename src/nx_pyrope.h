...
#define SECONDBOOT_STACK	0x1000		// 4KB

#define BL2_IMAGE_SIZE		0x10000		// 64KB
#define BL2_STACK_SIZE		0x10000		// 64KB

#define BASEADDR_SRAM		0xFFFF0000
#define BASEADDR_NFMEM		0x2C000000
#define BASEADDR_DDRSDRAM	0x80000000
#define BASEADDR_SECUREMEM	0xB0000000
#define SECUREMEM_SIZE		0x01000000	// 16MB
